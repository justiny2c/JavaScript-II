...
let fullName =[]
let fullNames = runners.forEach(function(x){
...
let allCaps = runners.map(function(y){
  return y.first_name.toUpperCase();
})
...
let largeShirts = runners.filter((z) => {
  return z.shirt_size == "L"
})
...
// Problem 1 -- First and Last name of Runners with over $100 Donations

let vip_list = runners.map(function(a){
  if (a.donation > 100) {
